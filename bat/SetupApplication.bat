...
:: Android packaging
set AND_CERT_NAME="Brickaders"
set AND_CERT_PASS=nasheez
set AND_CERT_FILE=cert\Brickaders.p12
...
set IOS_PROVISION=cert\Brickaders.mobileprovision
...
set APP_ID=air.Brickaders

:: Output packages
set DIST_PATH=dist
set DIST_NAME=Brickaders
